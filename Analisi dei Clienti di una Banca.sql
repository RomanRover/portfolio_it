...
DROP TEMPORARY TABLE IF EXISTS TIPO_TRANS_OUT;

CREATE TEMPORARY TABLE TIPO_TRANS_OUT AS
SELECT 
CLIENTE.ID_CLIENTE,
...
SELECT * FROM TIPO_TRANS_OUT;

/* NUMERO DI TRANSAZIONI IN ENTRATA PER TIPOLOGIA (UN INDICATORE PER TIPO) */
DROP TEMPORARY TABLE IF EXISTS TIPO_TRANS_IN;

CREATE TEMPORARY TABLE TIPO_TRANS_IN AS
SELECT 
CLIENTE.ID_CLIENTE,
...
TIPO_TRANS_OUT.TIPO_TRANS_AMAZON,TIPO_TRANS_MUTUO,TIPO_TRANS_VOLO,TIPO_TRANS_HOTEL,TIPO_TRANS_SUPERMERCATO,
TIPO_TRANS_IN.TIPO_TRANS_STIPENDIO,TIPO_TRANS_PENSIONE,TIPO_TRANS_DIVIDENDI,
...
JOIN TIPO_TRANS_OUT ON ETA.ID_CLIENTE = TIPO_TRANS_OUT.ID_CLIENTE
JOIN TIPO_TRANS_IN ON ETA.ID_CLIENTE = TIPO_TRANS_IN.ID_CLIENTE
